...
test('bracketFromGPA', function(t) {
  ...
  t.deepEqual(recruiter.bracketFromGPA(2.49),0,"returns bracket zero");
  t.end();
});

test('recruiter function', function(t) {
  t.comment("dont hire ppl with degrees we dont recognize");
  ...
  t.deepEqual(retArr.length, 1, "returns expected num of interns");
